...
class Profile extends PureComponent {
  ...
  _onSaveInterests() {
    ...
    const personalInterestsSelected = personalInterests.filter(
    ...
    return (
      <div className={classes.profileContainer}>
        <div className={classes.welcomeContainer}>
          <label className={classes.welcomeTitle}>{Strings.welcome}, </label>

          <label className={classes.welcomeTitleUsername}>
        ...
        <label className={classes.linkButtonStyle} onClick={() => signOut()}>
          {Strings.logout}
        </label>
      </div>
    );
